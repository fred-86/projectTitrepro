...
const PopUpAlt = ({ place }) => {
  const { name, address, addressComplement, department, city, logo, url } = place;
    ...
    <div className="popUpAlt">
      ...
      <div className="popUpAlt__content">
        <section className="description">
          ...
          <a className="description__link" href={url}>Voir le site</a>
        </section>
        <aside className="info">
          <h2 className="info__address">Adresse</h2>
          <p className="info__text">{address}</p>
          <p className="info__text">{addressComplement}</p>
